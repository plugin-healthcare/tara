...
- Docstrings: follow the `pyproject.toml` convention (google by default) -- keep them short and to the point: purpose, key decisions, and how it works, plus args/returns/raises.
