...
**Correctness** — bugs, edge cases, error handling gaps **Clarity** — naming, complexity, readability **Conventions** — does it follow project patterns (see AGENTS.md) **Tests** — missing coverage for the changed behaviour **Security** — any obvious OWASP Top 10 concerns
