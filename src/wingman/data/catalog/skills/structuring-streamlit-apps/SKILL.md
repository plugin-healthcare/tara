...
description: "Use when creating or structuring a Streamlit application: the entrypoint, the multipage pages/ folder, .streamlit/config.toml, dependencies via uv, and keeping business logic testable and separate from the UI. Applies wingman's Python conventions on top of uv init."
---
