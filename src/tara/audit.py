...
This is the deterministic linter behind ``tara audit``. It checks the things
...
# ── MCP config (.mcp.json / .tara/mcp.local.json) ──────────────────────────
...
MCP_CONFIGS = (Path(".mcp.json"), Path(".tara") / "mcp.local.json")
